...
module.exports = {
    ...
    // cacheDirectory: 'C:\\Users\\meyer\\AppData\\Local\\Temp\\jest',
    ...
    moduleNameMapper: {
        ...lernaAliases({ sourceDirectory: false })
    },
    ...
    // A list of paths to directories that Jest should use to search for
    // files in
    roots: [
        '<rootDir>/packages'
    ],
