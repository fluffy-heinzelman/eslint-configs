...
const heinzelmanStyleRules = require('@heinzelman-labs/eslint-config-base/rules/style').rules;

const dangleRules = heinzelmanStyleRules['no-underscore-dangle'] || airbnbStyleRules['no-underscore-dangle'];

module.exports = {
    // View link below for react rules documentation
    // https://github.com/yannickcr/eslint-plugin-react#list-of-supported-rules
    rules: {
        'no-underscore-dangle': !dangleRules ? 'off' : [dangleRules[0], assign({}, dangleRules[1], {
        ...
        // Allow JSX code in TypeScript and JavaScript files (tests written in .js)
        // @airbnb-delta
